...
type Command struct {
	...
	// DisableAutoGenTag defines, if gen tag ("Auto generated by spf13/kcli...")
...
func (c *Command) HelpFunc() func(*Command, []string) {
	...
	return func(c *Command, a []string) {
		...
		// See https://github.com/kumose/kcli/issues/1002
...
func (c *Command) ExecuteC() (cmd *Command, err error) {
	...
	// Workaround FAIL with "go test -v" or "kcli.test -test.v", see #155
	if c.args == nil && filepath.Base(os.Args[0]) != "kcli.test" {
		args = os.Args[1:]
	}
...
// Concrete example: https://github.com/kumose/kcli/issues/393#issuecomment-282741924.
